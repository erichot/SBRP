...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250216121330_InboundStockOrder.Key5")]
    partial class InboundStockOrderKey5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 832, DateTimeKind.Local).AddTicks(7240),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 832, DateTimeKind.Local).AddTicks(9230),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 830, DateTimeKind.Local).AddTicks(1985),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 832, DateTimeKind.Local).AddTicks(9687),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 832, DateTimeKind.Local).AddTicks(4951),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 2, 16, 20, 13, 25, 832, DateTimeKind.Local).AddTicks(9760),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.InboundStockOrder", b =>
                {
                    ...
                    b.Property<int>("OrderNo")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("(CAST([OrderDateNo] AS INT) * 65536 + CAST([DaySerialNo] AS INT)) PERSISTED NOT NULL");
