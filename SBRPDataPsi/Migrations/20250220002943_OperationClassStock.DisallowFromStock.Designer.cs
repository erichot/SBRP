...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250220002943_OperationClassStock.DisallowFromStock")]
    partial class OperationClassStockDisallowFromStock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 462, DateTimeKind.Local).AddTicks(2504),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 462, DateTimeKind.Local).AddTicks(4603),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 459, DateTimeKind.Local).AddTicks(6133),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 462, DateTimeKind.Local).AddTicks(5064),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 462, DateTimeKind.Local).AddTicks(263),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 2, 20, 8, 29, 39, 462, DateTimeKind.Local).AddTicks(5143),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.OperationClassStock", b =>
                {
                    ...
                    b.Property<bool>("DisallowFromStock")
                        .HasColumnType("bit");

                    b.Property<bool>("DisallowToStock")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsFromThisStock")
                        .HasColumnType("bit");

                    b.Property<bool>("IsToThisStock")
                        .HasColumnType("bit");
