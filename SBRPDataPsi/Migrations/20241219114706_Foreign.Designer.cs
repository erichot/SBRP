...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20241219114706_Foreign")]
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 439, DateTimeKind.Local).AddTicks(2317),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 439, DateTimeKind.Local).AddTicks(4489),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 435, DateTimeKind.Local).AddTicks(2082),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 439, DateTimeKind.Local).AddTicks(4973),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 438, DateTimeKind.Local).AddTicks(9957),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2024, 12, 19, 19, 47, 3, 439, DateTimeKind.Local).AddTicks(5052),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.BaseWebPageSIG", b =>
                {
                    ...
                    b.HasOne("SBRPDataPsi.Models.MenuitemSIG", "MenuitemSIG")
                        .WithOne()
                        .HasForeignKey("SBRPDataPsi.Models.BaseWebPageSIG", "NodeNo", "SIGNo");
