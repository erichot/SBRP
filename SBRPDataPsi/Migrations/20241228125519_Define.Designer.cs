...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20241228125519_Define")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 394, DateTimeKind.Local).AddTicks(7276),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 394, DateTimeKind.Local).AddTicks(9241),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 392, DateTimeKind.Local).AddTicks(2880),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 394, DateTimeKind.Local).AddTicks(9704),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 394, DateTimeKind.Local).AddTicks(4967),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2024, 12, 28, 20, 55, 16, 394, DateTimeKind.Local).AddTicks(9774),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.ProductGeneralCategoryItem", b =>
                {
                    b.HasOne("SBRPDataPsi.Models.ProductGeneralCategoryDefinition", "ProductGeneralCategory")
                        .WithMany()
                        .HasForeignKey("PGCategoryNo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductGeneralCategory");
                });
