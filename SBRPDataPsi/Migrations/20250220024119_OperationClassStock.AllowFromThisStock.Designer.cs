...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250220024119_OperationClassStock.AllowFromThisStock")]
    partial class OperationClassStockAllowFromThisStock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 747, DateTimeKind.Local).AddTicks(3354),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 747, DateTimeKind.Local).AddTicks(5380),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 744, DateTimeKind.Local).AddTicks(8195),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 747, DateTimeKind.Local).AddTicks(5837),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 747, DateTimeKind.Local).AddTicks(1145),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 2, 20, 10, 41, 15, 747, DateTimeKind.Local).AddTicks(5908),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
