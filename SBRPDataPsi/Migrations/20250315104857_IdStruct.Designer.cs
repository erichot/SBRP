...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250315104857_IdStruct")]
    partial class IdStruct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 594, DateTimeKind.Local).AddTicks(3447),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 594, DateTimeKind.Local).AddTicks(5550),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 591, DateTimeKind.Local).AddTicks(7994),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 594, DateTimeKind.Local).AddTicks(6021),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 594, DateTimeKind.Local).AddTicks(1091),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 3, 15, 18, 48, 53, 594, DateTimeKind.Local).AddTicks(6093),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.Product", b =>
                {
                    ...
                    b.Property<string>("ProductIdBySupplier")
                        .IsRequired()
                        .HasColumnType("CHAR(32)");
