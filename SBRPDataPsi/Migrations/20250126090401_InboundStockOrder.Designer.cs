...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250126090401_InboundStockOrder")]
    partial class InboundStockOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 110, DateTimeKind.Local).AddTicks(3988),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 110, DateTimeKind.Local).AddTicks(5988),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 107, DateTimeKind.Local).AddTicks(6925),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 110, DateTimeKind.Local).AddTicks(6520),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 110, DateTimeKind.Local).AddTicks(1561),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 1, 26, 17, 3, 58, 110, DateTimeKind.Local).AddTicks(6590),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
