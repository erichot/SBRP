...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250219145747_OperationClassStock1")]
    partial class OperationClassStock1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 222, DateTimeKind.Local).AddTicks(2651),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 222, DateTimeKind.Local).AddTicks(4664),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 219, DateTimeKind.Local).AddTicks(7763),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 222, DateTimeKind.Local).AddTicks(5125),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 222, DateTimeKind.Local).AddTicks(380),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 2, 19, 22, 57, 43, 222, DateTimeKind.Local).AddTicks(5197),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
