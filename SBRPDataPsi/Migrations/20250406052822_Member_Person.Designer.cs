...
namespace SBRPDataPsi.Migrations
{
    ...
    [Migration("20250406052822_Member_Person")]
    partial class Member_Person
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("seqMember", "psi")
                .StartsAt(300001L);
            ...
            modelBuilder.Entity("SBRPData.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyPhone = "",
                            CompanyWeb = "",
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 544, DateTimeKind.Local).AddTicks(3683),
            ...
            modelBuilder.Entity("SBRPData.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 544, DateTimeKind.Local).AddTicks(5766),
                            CreatedPerson = (short)90,
            ...
            modelBuilder.Entity("SBRPData.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PersonNo = -1,
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 541, DateTimeKind.Local).AddTicks(4708),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = true,
                            IsSystemPredefined = true,
                        ...
                        {
                            PersonNo = 1,
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 544, DateTimeKind.Local).AddTicks(6254),
                            CreatedPerson = (short)90,
                            IsDeleted = false,
                            IsDisabled = false,
                            IsSystemPredefined = true,
            ...
            modelBuilder.Entity("SBRPData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserNo = (short)-1,
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 544, DateTimeKind.Local).AddTicks(1255),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
                        ...
                        {
                            UserNo = (short)1,
                            CreatedDate = new DateTime(2025, 4, 6, 13, 28, 18, 544, DateTimeKind.Local).AddTicks(6336),
                            CreatedPerson = (short)90,
                            Email = "",
                            HasBeenLocked = false,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("SBRPDataPsi.Models.Member", b =>
                {
                    b.Property<int>("MemberNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValueSql("NEXT VALUE FOR psi.seqMember");
