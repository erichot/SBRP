...
namespace SBRPDataPsi.Models
{
    ...
    /// 單一人員具有的功能選單項目
    /// </summary>
    [Table(nameof(MenuitemAppUser), Schema = SBRPData.DbSystemModel.DB_Schema_psi)]
    [PrimaryKey(nameof(NodeNo), nameof(AppUserNo))]
    public class MenuitemAppUser
    {
