...
$(function() {
    ...
    const jsCI_ItemNo = JS_GetEdFieldIndexByName(edFieldOptions, CN_ISOD_CN_SOD_ItemNoItemNo);
    ...
    const jsCI_DiscountPercentage = JS_GetEdFieldIndexByName(edFieldOptions, CN_SOD_DiscountPercentage);
    const jsCI_ActualSellingPrice = JS_GetEdFieldIndexByName(edFieldOptions, CN_SOD_ActualSellingPrice);
    const jsCI_Quantity = JS_GetEdFieldIndexByName(edFieldOptions, CN_SOD_Quantity);
