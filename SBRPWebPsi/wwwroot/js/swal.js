...
function fnSwalBtnConfirmToSend_OnClick(_triggerBtnID) {
    const TIT_ConfirmBeforeSign = "Sending";
    const MSG_ConfirmBeforeSign = "Send email now？";
...
function fnSwalBtnConfirmForceDelete_OnClick(_triggerBtnID, _msg) {
    const TIT_ConfirmBeforeDelete = "Force Deletion";
    if (_msg == undefined) _msg = '';
    const MSG_ConfirmBeforeDelete = "Force to delete " + _msg + " ？";
    fnSwalBtnConfirm_OnClick(_triggerBtnID, TIT_ConfirmBeforeDelete, MSG_ConfirmBeforeDelete, ICO_SwalIconQuestion);
};
