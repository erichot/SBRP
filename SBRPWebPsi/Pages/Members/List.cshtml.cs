...
namespace SBRPWebPsi.Pages.Members
{
    ...
    {
        private const string m_PageId = "BIMB0101";
        ...
        [BindProperty]
        public MemberFilterViewModel PG_Filter { get; set; } = new MemberFilterViewModel();
        
        public List<MemberViewModel> PG_List { get; set; }
        ...
        public async Task OnGetAsync()
        {
            ...
            PG_List = await m_MemberBindingService.GetListAsync(PG_Filter);
