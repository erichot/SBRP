...
namespace SBRPWebPsi.Pages.Orders.StockTransfers
{
    ...
    {
        private const string m_PageId = "ORST0101";
        ...
        [BindProperty]
        public StockTransferOrderFilterViewModel PG_Filter { get; set; } = new StockTransferOrderFilterViewModel();
        
        public List<StockTransferOrderViewModel> PG_List { get; set; }
        ...
        public async Task OnGetAsync()
        {
            ...
            PG_List = await m_StockTransferOrderBindingService.GetListAsync(PG_Filter);
