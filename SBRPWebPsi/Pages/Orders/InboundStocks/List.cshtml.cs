...
namespace SBRPWebPsi.Pages.Orders.InboundStocks
{
    ...
    public class ListModel : PageModel
    {
        ...
        [BindProperty]
        public InboundStockOrderFilterViewModel PG_Filter { get; set; } = new InboundStockOrderFilterViewModel();
        
        public List<InboundStockOrderViewModel> PG_List { get; set; }
        ...
        public async Task OnGetAsync()
        {
            ...
            if (short.TryParse(cookie, out var aaa)) PG_Filter.SupplierNo = aaa;
        ...
        public async Task OnPostRefreshAsync()
        {
            ...
            Response.Cookies.Append("su", PG_Filter.SupplierNo?.ToString()??string.Empty);
            await Page_LoadAsync();
        }
