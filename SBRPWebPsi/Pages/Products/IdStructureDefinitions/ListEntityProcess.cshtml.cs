...
namespace SBRPWebPsi.Pages.Products.IdStructureDefinitions
{
    [Authorize]
    public class ListEntityProcessModel : PageModel
    {
        private const string m_PageId = "PTID0107";
        ...
        [BindProperty]
        public List<ProductIdStructureDefinitionViewModel> PG_List { get; set; }
        ...
        public async Task OnGetAsync(OperationEntityLoadingPolicyEnum _loadingPolicy = default(byte))
        {
            ...
            PG_List = await
                m_ProductIdStructureDefinitionBindingService.GetListAsync(_includeDetails:true);
        ...
        public async Task OnGetAddAsync()
        {
            ...
            PG_List = await m_ProductIdStructureDefinitionBindingService.AddNewDefaultAsync();
        ...
        public async Task<IActionResult> OnPostInsertAsync()
        {
            ...
            var result = await 
                m_ProductIdStructureDefinitionBindingService
                    .ProcessToInsertAsync(PG_List);
