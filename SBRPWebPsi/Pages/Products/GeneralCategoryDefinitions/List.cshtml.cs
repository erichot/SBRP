...
namespace SBRPWebPsi.Pages.Products.GeneralCategoryDefinitions
{
    ...
    {
        private const string m_PageId = "PTGC0101";
        ...
        public List<ProductGeneralCategoryDefinitionViewModel> PG_List { get; set; }
        ...
        public async Task OnGetAsync()
        {
            ...
            PG_List = await m_ProductGeneralCategoryDefinitionBindingService
                .GetListAsync(new ProductGeneralCategoryDefinition());
