...
[Table("MT_ProductFlowStatistics_ByStore")]
public partial class MT_ProductFlowStatistics_ByStore
{
    [Key]
    [StringLength(32)]
    ...
    public short TranInSpFlag { get; set; }
    ...
    public short TranOutSpFlag { get; set; }
