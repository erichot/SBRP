...
[Keyless]
public partial class VRP_ProductCounterInventorySaleQty_EachStore_YURUBRA
{
    [StringLength(32)]
    ...
    public int? TranInStockSubTotal84 { get; set; }

    public int? TranInStockWithoutReceived84 { get; set; }

    public int? TranInStockWithReceived84 { get; set; }

    public int? StockSubTotal84 { get; set; }

    public int? StockSubTotalWithReceived84 { get; set; }

    public int? StockSubTotalWithoutReceived84 { get; set; }

    public int? StockSubTotalWithReceivedWithoutCustomerOrder84 { get; set; }

    public int? CustomerOrderQty84 { get; set; }

    public int? CustomerOrderQtyUnPackage84 { get; set; }

    public int? CustomerOrderQtyPackaged84 { get; set; }
