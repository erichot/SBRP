...
[Keyless]
public partial class VRP_ProductCounterInventorySaleQty_EachStore_31851271
{
    [StringLength(32)]
    ...
    public DateOnly? InStockFirstDate04 { get; set; }

    public DateOnly? InStockLastDate04 { get; set; }

    public int? InStockSubTotal04 { get; set; }

    public int? StockSubTotal04 { get; set; }

    public DateOnly? SaleFirstDate04 { get; set; }

    public DateOnly? SaleLastDate04 { get; set; }

    public int? SaleSubTotal04 { get; set; }
