...
namespace SBRPBussinessPsi.Models
{
    ...
    public static class BusinessSystem
    {
        ...
        //{
        //    DateTime result = default;
        //    if (!DateTime.TryParseExact(_dateNo.ToString(), DbSystem.DateNumberFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out result))
        //    {
        //        result = default;
        //    }
    ...
    public class ValidationResultEntity
    {
        ...
        public ValidationResultEntity(System.ComponentModel.DataAnnotations.ValidationResult _validationResult = null)
        {
    ...
    public class BusinessProcessResult<T> : BusinessProcessResult
    {
        ...
        public BusinessProcessResult OnlyBusinessProcessResult()
        {
