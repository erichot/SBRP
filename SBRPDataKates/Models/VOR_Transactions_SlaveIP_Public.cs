...
[Keyless]
public partial class VOR_Transactions_SlaveIP_Public
{
    ...
    public int? TranDateTimeStamp { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? TranTime { get; set; }

    public int? TranCreatedTimeStamp { get; set; }
    ...
    public short? SlaveID_Public { get; set; }
    ...
    [StringLength(30)]
    public string? SlaveName_Public { get; set; }

    [StringLength(255)]
    public string? SlaveDescription_Public { get; set; }

    public int? SlaveCategoryID_Public { get; set; }

    [StringLength(16)]
    public string? SlaveCategoryName_Public { get; set; }
